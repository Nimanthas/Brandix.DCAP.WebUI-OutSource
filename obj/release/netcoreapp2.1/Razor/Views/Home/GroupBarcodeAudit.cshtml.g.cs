#pragma checksum "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\GroupBarcodeAudit.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "013aa0612dad2eb723a0fb21b4c60a348e8bf717"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Home_GroupBarcodeAudit), @"mvc.1.0.view", @"/Views/Home/GroupBarcodeAudit.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Home/GroupBarcodeAudit.cshtml", typeof(AspNetCore.Views_Home_GroupBarcodeAudit))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"013aa0612dad2eb723a0fb21b4c60a348e8bf717", @"/Views/Home/GroupBarcodeAudit.cshtml")]
    ...
    public class Views_Home_GroupBarcodeAudit : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#line 1 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\GroupBarcodeAudit.cshtml"
  
    Layout = "_Layout";

#line default
#line hidden
            BeginContext(32, 5198, true);
   ...
   ");
        ...
        $('#pageTitleBar').html('<i class=""fas fa-barcode pageMainIcon""></i><span class=""pageTitle"">DCap - Group Tag Audit</span><button id=""new-request-button"" class=""k-button"" style=""background");
            WriteLiteral(@"-color: #04630; border: none; font-size: 18px; font-weight: 600; color: #000000; margin-left: 25px;"" onclick=""openGroupBarcodeDetail()""><span>Barcode Detail</span></button>');
    ...
    function checkLoginStatus() { //NE
        ...
        i");
            WriteLiteral(@"f (sessionStorage.getItem(""UserId"") != """") {
    ...
    function checkBarcodeIsValid() {
        ...
        if (!haltsystem) {
            ...
            EndContext();
            BeginContext(5231, 14, false);
#line 154 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\GroupBarcodeAudit.cshtml"
                 Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(5245, 23896, true);
            WriteLiteral(@"/Lookup/GetStyleScheduleByBarcode?Barcode=' + $(""#barcodeBcodeTxt"").val(),
                ...
                success: function (data) {
                    ...
                    if (data != null) {
                        ...
                        sele");
            WriteLiteral(@"ctedGroupTagDesc = data.StyleDesc;
                        ...
                        //Check ");
            WriteLiteral(@"whether barcode color is matched with the user input //scannedBarcode.colorId != 0 && selectedGatePass != null && scannedBarcode.colorId != selectedGatePass.l4id
                        else if (false) {
            ...
            WriteLiteral(@"          isValidBarcode = true;
                        ...
                        flag = false;
                        msgBox.show('මෙම බාර්කෝඩ් අගය වලංගු නැත.', 'This ba");
            WriteLiteral(@"rcode is not valid.', 'අවවාදයයි / Warning', 'BS12', 'Warning', function () {
                            scannedBarcode = null;
                            $(""#barcodeBcodeTxt"").val("""");
                            $(""#barcodeBcodeTxt"").focus();
    ...
    ");
            WriteLiteral(@"            index = id;
                ...
                if ($('#status').html() != 'Found' && $('#status').html() != 'Duplicate') {
                    ...
                    $('#status').");
            WriteLiteral(@"removeClass('control-datalabel-scannedstatus-pass');
                }
            }
    ...
    function updateBarcodeScan() {
      ...
      ");
            WriteLiteral(@"  if (scannedBarcode.styleNo != $(""#barcodeGroupTagTxt"").val()) {
        ...
        //Check whether barcode color is matched with the user input
            ...
            errorbe");
            WriteLiteral(@"forestauscomplete = errorbeforestauscomplete + ' ' + 'Selected Color does not match with Barcode.'
            sacanComplete = false;
            EnableControllers();
            return;
        }
            ...
            errorbeforest");
            WriteLiteral(@"auscomplete = errorbeforestauscomplete + ' ' + 'You do not have access to selected Scan Action.'
            sacanComplete = false;
            EnableControllers();
            return;
        }
            ...
            loadTablerV");
            WriteLiteral(@"alues(ScannedItem);
        }
    }
    ...
    function initializeControlEvents() { //ND
        ...
        $(""#barcodeBreakdowbDetails"").kendoGrid({
            ...
            dataBound: function (e) {
                ...
                // it");
            WriteLiteral(@"erate the table rows and apply custom row and cell styling
            ...
            columns: [
                {title:""Status"",field:""status"",width:""28%"", filterable: false, template: ""#if (status == '0' ) {# <div class='mb-2 mr-2 badge badge-primary const-width-badge' style='width: 90%; height: 16px; font-size: ");
            WriteLiteral(@"16px; margin-left: -3px;'>Loaded"" + 
    ...
    ");
            WriteLiteral(@"            { field: ""colorId"", title: ""l4 No"", width: ""10%"", hidden: true },
        ...
        $(""#errorBarcodeBreakdowbDetails"").kendoGrid({
            ...
            columns: [
                ...
                { field: ""barcode"", title: ""Barcode No"", width: ""21%"" },
                { field: ""styleId"", title: ""l1 No"", width: ""10%"", hidden: true },
                { field: ""styleNo"", title: ""Style"", width");
            WriteLiteral(@": ""15%"" },
                { field: ""scheduleId"", title: ""l2"", width: ""9%"", hidden: true },
                { field: ""scheduleNo"", title: ""Shedule No"", width: ""17%"" },
                { field: ""PONo"", title: ""PO No"", width: ""15%"" },
                ...
                { field: ""qty02"", title: ""Scrap"", width: ""10%"", filterable: false },
          ");
            WriteLiteral(@"      { field: ""qty03"", title: ""Rework"", width: ""11%"", filterable: false }
            ]
        }).data(""kendoGrid"");
        ...
        $('#groupTagSearchBtn').click(function () {
            ...
            groupBarcodeSearchWindow.wrapper.find('.k-window-titlebar').c");
            WriteLiteral(@"ss({
            ...
            groupTagSearchGrid = $(""#groupTagSearchGrid"").kendoGrid({
                ...
                dataSource: {
                    transport: {
                        read: '");
            EndContext();
            BeginContext(29142, 14, false);
#line 608 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\GroupBarcodeAudit.cshtml"
                          Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(29156, 4993, true);
            WriteLiteral(@"/Lookup/GetGroupTagDetailsByGroupBarcode'
                    },
                    schema: {
                        model: {
                            fields: {
 ...
 ");
            WriteLiteral(@"               width: ""90%"",
                ...
                columns: [
                    ...
                    { field: ""txnMode"", title: ""Txn Mode");
            WriteLiteral(@""", width: ""10%"", hidden: true },
            ...
            $(""#groupTagSearchWindowGroupTagTxt"").keydown(function (e) {
                if (e.keyCode == 13) {
                    if ($(""#groupTagSearchWindowGroupT");
            WriteLiteral(@"agTxt"").val().length > 0) {
            ...
            gatePassSearchGrid = $(""#gatePassSearchGrid"").kendoGrid({
                ...
                dataSource: {
                    transport: {
                        read: '");
            EndContext();
            BeginContext(34150, 14, false);
#line 718 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\GroupBarcodeAudit.cshtml"
                          Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(34164, 9107, true);
            WriteLiteral(@"/Lookup/GetGatePassDetailsByGroupTag?groupTagNo=' + selectedGroupTagNo,
                    },
                    schema: {
                        model: {
                            fields: {
                ...
                columns: [
                    ...
                    { field: ""qty01"", title: ""Quant");
            WriteLiteral(@"ity"", width: ""70%"" }
                ]
            }).data(""kendoGrid"");
        ...
        $(""#groupTagSearchWindowGroupTagTxt"").keyup(function () {
            $('#barcodeBcodeTxt').val("""");
 ");
            WriteLiteral(@"           groupTagSearchGrid.dataSource.data([]);
        });
    ...
    function getSessionInfo() { //NE
        ...
        userPermissionList = JSON.parse(sessionStorage.getItem(""UserP");
            WriteLiteral(@"ermissionList""));
    ...
    function setPageControlsStartupStatus() { //NE
        ...
        $('#lastB");
            WriteLiteral(@"arcodeDataLabel').html("""");
        $('#lastAction').html("""");
        $('#lastTxMode').html("""");
    ...
    function onChangeGroupTag(arg) { //NS
        ...
        if ($(""#groupTagSearchWindowGr");
            WriteLiteral(@"oupTagTxt"").val().length > 0) {
    ...
    function onGroupTagSearchClose() { //NS
        if (selectedGroupTag != null) {
            ...
            $('#groupTagDataLabel').html(selectedGroupTagDesc);
            $('#");
            WriteLiteral(@"txnModeDataLabel').html(selectedGroupTag.txnMode);
            resetControls();
    ...
    function loadGaramentsInGroupTag(groupTag, txnMode) { //NE
        ...
        $.ajax({
            url: '");
            EndContext();
            BeginContext(43272, 14, false);
#line 949 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\GroupBarcodeAudit.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(43286, 6384, true);
            WriteLiteral(@"/Lookup/GetGarametsBarcodeByGroupTag?barcode=' + groupTag + '&txnmode=' + parseInt(txnMode),
            type: 'GET',
            dataType: 'json',
            //async: false,
            ...
            success: function (response) {
                ...
                if (response != null) {
                    if (response.length != 0) {
                        ...
                        $('#status').html('Loaded');
                        $('#status').removeClass('blinktext');
                        $('#status').removeClass('control-datala");
            WriteLiteral(@"bel-scannedstatus-fail');
                        $('#status').addClass('control-datalabel-scannedstatus-pass');
                        var GridData = [];
            ...
            WriteLiteral(@"
                        ...
                        $('#status').addClass('blinktext');
                        $('#status').addClass('con");
            WriteLiteral(@"trol-datalabel-scannedstatus-fail');
                        $('#status').removeClass('control-datalabel-scannedstatus-pass');
                        EnableControllers();
                    }
                } else {
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                ...
                msgBox.show('දෝෂයකි. කරුණාකර නැවත උත්සාහ කරන්න..' , 'Error. Please try again.', 'Warning', 'BU05', 'Warning', null);
 ");
            WriteLiteral(@"               $('#status').html('Failed');
                $('#status').addClass('blinktext');
                $('#status').addClass('control-datalabel-scannedstatus-fail');
                $('#status').removeClass('control-datalabel-scannedstatus-pass');
            }
    ...
    function onChangeGatePass(arg) { //NS
     ...
     ");
            WriteLiteral(@"   $(""#barcodeBcodeTxt"").select();
        $(""#barcodeBcodeTxt"").focus();
    }
    ...
    function onGatePassSearchClose() { //NS
        ...
        gatePassSearchGrid.dataSource.");
            WriteLiteral("data([]);\r\n        $(\"#barcodeBcodeTxt\").select();\r\n        $(\"#barcodeBcodeTxt\").focus();\r\n    }\r\n\r\n    function GetClientByWF(arg) {\r\n        refreshmsgBoxHeaderStyle();\r\n        //if (wfid != null){ \r\n        $.ajax({\r\n            url: \'");
            EndContext();
            BeginContext(49671, 14, false);
#line 1088 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\GroupBarcodeAudit.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(49685, 3758, true);
            ...
            success: function (response) {
                if (response != null) {
                    ...
                    clientconfig = {
                        ...
                        ""operationName"": r");
            WriteLiteral(@"esponse.operationName,
                    ...
                    msgBox.show('කාර්ය ප්‍රවාහයට අවසර නැත. කරුණාකර තොරතුරු තාක්ෂණ නිලධාරියෙකු අමතන්න.',
                      ");
            WriteLiteral(@"  'Client is not configured for this Workflow..WFID = ' + wfid + ' Please contact a IT helpdesk officer',
                        'අවවාදයයි / Warning',
                        'BS22',
                        'Warning',
                        null);
    ...
    function refresValuesonChangeStyle(arg) { //NE
        refreshmsgBoxHeaderStyle();
        if (sel");
            WriteLiteral(@"ectedGroupTag != null) {
            $(""#barcodeBcodeTxt"").val("""");
            $(""#barcodeBcodeTxt"").removeAttr(""disabled"");
            scannedBarcode = null;
            selectedGatePass = null;
    ...
    function getWFDEPInstId(arg) {
        $.ajax({
            //url: '");
            EndContext();
            BeginContext(53444, 14, false);
#line 1178 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\GroupBarcodeAudit.cshtml"
               Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(53458, 120, true);
            WriteLiteral("/Security/GetWfDEPInstByClientWF?ClientId=\' +  clientconfig.clientId + \'&WFId=\' + clientconfig.wfId,\r\n            url: \'");
            EndContext();
            BeginContext(53579, 14, false);
#line 1179 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\GroupBarcodeAudit.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(53593, 17276, true);
  ...
  ");
        ...
        <div class=""col-xs-6""
            ...
            <div class=""row"">
                ...
                <div class=""col-xs-4"">
                    <label class=""co");
            WriteLiteral(@"ntrol-datalabel control-datalabel-search"" id=""groupTagDataLabel""></label>
            ...
            <div class=""row"">
                ...
                <div class=""col-xs-4"">
                    <");
            WriteLiteral(@"label class=""control-datalabel control-datalabel-search"" id=""gatePassDataLabel""></label>
                </div>
            </div>
            <div class=""row"">
            ...
            <div class=""bc_rightcontent"">
                <div class=""row"">
                    <div class=""col-xs-12"">
                     ...
                     ");
            WriteLiteral(@"       <div class=""row"" style=""margin-top: 8px; margin-bottom: 8px;"">
                                <div class=""col-xs-6"">
                                ...
                                <div class=""col-xs-6"">
                                    ...
                                    <div class=""row"">
                                        <div class=""col-xs-12"">
          ");
            WriteLiteral(@"                                  <label class=""control-scan-status"" style=""padding-left: 0px;"">Scanned Qty</label>
                ...
                <div class=""row"" style=""padding-right: 15px;"">
                    <div class=""col-xs-12"">
                      ");
            WriteLiteral(@"  <div class=""row  roundCornerGroupBox"" style=""height:24vh;"">
                            <div class=""col-xs-7"" style=""padding-left: 0px;"">
                                ...
                                <div class=""row"" style=""height:7vh; overflow: auto;"">
                                    ...
                                    <label class=""bcInfo");
            WriteLiteral(@"DataLabel col-xs-8"" id=""bcColorDataLabel""></label>
                                </div>
                            </div>
                            <div class=""col-xs-5"" style=""padding-left: 0px;"">
                                ...
                                <div class=""row"" ");
            WriteLiteral(@"style=""height:7vh; overflow: auto;"">
    ...
    <div class=""row"" class=""m-2"" style=""margin-right: 15px;"" id=""barcodeTableView"">
        <div id=""opLables"" class=""roundCornerGroupBox_Scrolabale"" hidden=""hidden""
            ...
            <div class=""row col-md-12 roundCornerGroupBox_PO_Counter""
                ...
                <div class=""scrolable-field"" id=""barcodeBreakdowbDetails"" style=""margin-top: 15px; ");
            WriteLiteral(@"margin-bottom: 15px; overflow: auto; height: 420px;""></div>
            </div>
        </div>
    </div>
...
<div id=""groupBarcodeSearchWindow"" class=""styleSearchWindow"" hidden=""hidden"">
    <div class=""row"">
        <div class=""col-xs-5"">
            ...
            WriteLiteral(@" placeholder=""Enter Group Tag Number""
