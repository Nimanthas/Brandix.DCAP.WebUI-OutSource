#pragma checksum "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d6d069f98e79b0b50812668cb4a15517cb4f8f6f"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Home_Bulk), @"mvc.1.0.view", @"/Views/Home/Bulk.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Home/Bulk.cshtml", typeof(AspNetCore.Views_Home_Bulk))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d6d069f98e79b0b50812668cb4a15517cb4f8f6f", @"/Views/Home/Bulk.cshtml")]
    ...
    public class Views_Home_Bulk : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#line 1 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
  
    Layout = "_Layout";

#line default
#line hidden
            BeginContext(32, 17444, true);
    ...
    $(document).ready(function () {
        ...
        if(clientconfig.wfId == 0) {
            ...
            //wi");
            WriteLiteral(@"ndow.location.href = ""Menu"";
        }
        ...
        if (isValidClient == Answer.Null) {
            ...
            if (clientconfig.dataCaptureMode == DataCaptureMode.Barcode) {
                msgBox.show('මෙම යන්ත්‍රයට බල්ක් අප්ඩේට් කිරීම සඳහා අවසර නැත.', 'This device is not authorized for Bulk update', 'අවවාදයයි / Warning', 'BU01', 'Warning', function () {
                    if (clientconfig.dataCaptureMode =");
            WriteLiteral(@"= DataCaptureMode.Barcode) {
    ...
    function initializeControls() {
        ...
        $(");
            WriteLiteral(@"""#ddlFactory"").kendoDropDownList({
            dataTextField: ""text"",
            dataValueField: ""value"",
            dataSource: data,
            index: 0,
      ...
      ");
            ...
            //change: onChangeQty,              
            ");
            WriteLiteral(@"selectable: ""multiple cell"",
            sortable: true,
            editable: true,
            filterable: true,
            save: function () {
        ...
        ");
            WriteLiteral(@"        { field: ""sizeId"", hidden: true },
                {
        ...
        function OnGrid3DataBound(e) {
            ...
            var grid = $(""#dgGQGrid3"").data");
            WriteLiteral(@"().kendoGrid; // $(""#grid"").data(""kendoGrid"");  
            var gridData = grid.dataSource.view();
            ...
            if (e.keyCode === kendo.keys.TAB) {
                ...
                if (!current.hasClass(""editable-cell"")) {
                    ...
                    if (!nextCell[0]) {
                        ...
                        var nextCell = current.parent().next().children("".edi");
            WriteLiteral(@"table-cell:first"");
                    }
        ...
        $(""#dgGQGrid2"").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: ""scrpQty"", title: ""Scrap Qty"", widt");
            WriteLiteral(@"h: ""50px""
        ...
        $(""#dgGQGrid3"").kendoGrid({
          ...
          ");
            ...
            columns: [
                ...
                { field: ""colorNo"", title: ""Colo");
            WriteLiteral(@"r"", width: ""100px"", editable: false },
        ...
        $(""#btnAdd"").on(""click"", function (value");
            WriteLiteral(@", args) {
        ...
        $(""#sbutton"").click(function () {
            ...
            if (scheduleno == null || scheduleno == """") {
                ...
                $(""#ddlFactory"").data(""kendoDropDownList"").");
            ...
            WriteLiteral("ajax({\r\n\r\n                    url: \'");
            EndContext();
            BeginContext(17477, 14, false);
#line 467 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
                     Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(17491, 3821, true);
            WriteLiteral(@"/Lookup/GetScheduleDetailBySchedule?ScheduleNo=' + scheduleno,
                    type: 'GET',
                    dataType: 'json',
                    //async: false,
 ...
 ");
            ...
            $(""#ddlSize"").data(""kendoDropDownList"").dataSource.data([]);
            $(""#ddlSize"").data(""kendo");
            WriteLiteral(@"DropDownList"").text("""");
            $(""#ddlScrapReason"").data(""kendoDropDownList"").dataSource.data([]);
            $(""#ddlScrapReason"").data(""kendoDropDownList"").text("""");
            $('#scrpQty').val('');
            $(""#datepicker"").data(""kendoDatePicker"").value(todayDate);
    ...
    function getFactory() {
        ...
        $.ajax({
            url: '");
            EndContext();
            BeginContext(21313, 14, false);
#line 558 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(21327, 1229, true);
            WriteLiteral(@"/Lookup/GetFactoryWFComboData?ScheduleNo=' + scheduleno,
            type: 'GET',
            dataType: 'json',
            //async: false,
            contentType: 'application/json',
            ...
            error: function (jqXHR, textStatus, errorThrown) {
              ");
            WriteLiteral("  formatErrorMessage(jqXHR, errorThrown, \"Bulk\");\r\n            }\r\n        });\r\n    }\r\n\r\n    function getOperation() {\r\n        //alert(\'WFID: \' + scheduleObject.wfId);\r\n        $.ajax({\r\n            url: \'");
            EndContext();
            BeginContext(22557, 14, false);
#line 596 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(22571, 3811, true);
            WriteLiteral(@"/Lookup/GetOpperationsByWFID?Wfid=' + scheduleObject.wfId,
            type: 'GET',
            dataType: 'json',
            //async: false,
            contentType: 'application/json',
...
");
            WriteLiteral(@"        // $(""#ddlSubOperation"").data(""kendoDropddlDownList"").dataSource.data([]);
        // $(""#ddlSubOperation"").data(""kendoDropDownList"").text("""");
    ...
    function operationChange() {
        ...
        if (operationText != null && operationText != """") {
            var operation = op");
            WriteLiteral(@"erationText.split('-');
...
*/
        $.ajax({
            url: '");
            EndContext();
            BeginContext(26383, 14, false);
#line 695 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(26397, 932, true);
            WriteLiteral(@"/Lookup/GetWFConfigurationbyID?WfdepinstId=' + wfdepinstId,
            type: 'GET',
            dataType: 'json',
            //async: false,
            contentType: 'application/json',
    ...
    function getHours(teamId) {
        ...
        $.ajax({
            url: '");
            EndContext();
            BeginContext(27330, 14, false);
#line 722 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(27344, 1117, true);
            WriteLiteral(@"/Lookup/GetProductionHoursComboData?TeamId=' + teamId,
            type: 'GET',
            dataType: 'json',
            //async: false,
            contentType: 'application/json',
    ...
    function getColour() {");
            ...
            EndContext();
            BeginContext(28462, 14, false);
#line 756 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(28476, 1956, true);
            WriteLiteral(@"/Lookup/GetColorsByStylesNo?Style=' + scheduleObject.styleNo,
            type: 'GET',
            dataType: 'json',
            //async: false,
            contentType: 'application/json',
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                formatError");
            WriteLiteral(@"Message(jqXHR, errorThrown, ""Bulk"");
            }
        });
    }
    ...
    function getSize() {
        ...
        $.ajax({
            url: '");
            EndContext();
            BeginContext(30433, 14, false);
#line 816 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(30447, 1109, true);
            WriteLiteral(@"/Lookup/GetSizesByStyleSheduleColor?L1id=' + l1 + '&L2id=' + l2 + '&L3id=' + l3 + '&L4id=' + l4 + '',
            type: 'GET',
            dataType: 'json',
            //async: false,
            contentType: 'application/json',
...
");
            WriteLiteral("    var scrapObject;\r\n    function getScrap() {\r\n        $.ajax({\r\n            url: \'");
            EndContext();
            BeginContext(31557, 14, false);
#line 848 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(31571, 1416, true);
    ...
    function getGrid() {
        ...
        if (l4 != """" && l4 != ""Select Color"") {
            ...
            $.ajax({
                url: '");
            EndContext();
            BeginContext(32988, 14, false);
#line 888 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
                 Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(33002, 1743, true);
            WriteLiteral(@"/Lookup/GetSizesByStyleSheduleColor?L1id=' + l1 + '&L2id=' + l2 + '&L3id=' + l3 + '&L4id=' + l4 + '',
                type: 'GET',
                dataType: 'json',
                //async: false,
    ...
    function getGrid3() {
        ...
        if (SoberSheetNo == """") {
            ...
            $.ajax({
                url: '");
            EndContext();
            BeginContext(34746, 14, false);
#line 935 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
                 Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(34760, 7001, true);
            WriteLiteral(@"/Lookup/GetSoberSheetDetails?SoberSheetNo=' + SoberSheetNo + '',
                type: 'GET',
                dataType: 'json',
                //async: false,
                contentType: 'application/json',
   ...
   ");
    ...
    function SaveGridData() {
        ...
        //if (jobN");
            WriteLiteral(@"umber == """" || jobNumber == null) {
        ...
        if (factoryText == ""Select Factory"") {
            ...
            $(""#ajaxBusy"").hide();
         ");
            WriteLiteral(@"   msgBox.show('', 'Please Select a Hour', 'Warning', 'BU03', 'Warning', null);
        }
        else {
            if (factoryText != null && factoryText != """") {
    ...
    function GetDatabySobersheetSCHNo(SSheetSCHId, SSheetSCHNo) {
        ...
        $.ajax({
            ...
            url: '");
            EndContext();
            BeginContext(41762, 14, false);
#line 1139 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(41776, 2046, true);
            WriteLiteral(@"/Lookup/GetScheduleDetailBySchedule?ScheduleNo=' + SSheetSCHNo,
            type: 'GET',
            dataType: 'json',
            //async: false,
            contentType: 'application/json',
            ...
            success: function (response) {
                if (response != null) {
                    ...
                    $(""#ddlFactory"").data(""kendoDropDown");
            WriteLiteral(@"List"").dataSource.data([]);
                    $(""#ddlFactory"").data(""kendoDropDownList"").text("""");
                    getFactory();
    ...
    function SoberSheetAlreadySaved() {
        ...
        $.ajax({
            ...
            url: '");
            EndContext();
            BeginContext(43823, 14, false);
#line 1190 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
             Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(43837, 2496, true);
            WriteLiteral(@"/Lookup/GetIsSoberSheetAlredySaved?SoberSheetNo=' + SoberSheetNo,
            type: 'GET',
            dataType: 'json',
            //async: false,
            contentType: 'application/json',
        ...
        if (selectedgridData != null) {
            ...
            if (UserInList != null && UserInList.length > 0) {
                ...
                $.ajax({
                    url: '");
            EndContext();
            BeginContext(46334, 14, false);
#line 1253 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
                     Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(46348, 5168, true);
            WriteLiteral(@"/BusinessLogics/UpdateBulkQty',
                    type: 'POST',
                    dataType: 'json',
                    async: false,
                    ...
                    success: function (response) {
                        ...
                        $.each(response, function (index, elements) {
                            var object = {
                                ...
                                success: elements.saveSuccessful");
            WriteLiteral(@"l
                            }
            ...
            msgBox.sh");
            WriteLiteral(@"ow('', 'Please enter quanity', 'Warning', 'BU06', 'Warning', null);
 ...
 ");
            WriteLiteral(@"               SewingInValidation = false;
            }
        }
        ...
        if (SewingInValidation) {
            ...
            ");
            WriteLiteral(@"            CreatedBy: sessionStorage.getItem(""UserId""),
                        CreatedMachine: clientconfig.clientId,
            ...
            WriteLiteral("        $.ajax({\r\n                        url: \'");
            EndContext();
            BeginContext(51517, 14, false);
#line 1372 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
                         Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(51531, 4358, true);
            WriteLiteral(@"/BusinessLogics/UpdateBulkQty',
                        type: 'POST',
                        dataType: 'json',
                        async: false,
                        ...
                        success: function (response) {
                            ...
                            $.each(response, function (index, elements) {
                                var object = {
                                    ...
                                    scheduleId: elements.scheduleId,
                                    scheduleNo: e");
            WriteLiteral(@"lements.scheduleNo,
                                    colorId: elements.colorId,
                                    colorNo: elements.colorNo,
                                    sizeId: elements.sizeId,
        ...
        if (selectedgridData != null) {
            ...
            if (UserInList != null && UserInList.length > 0) {
                ...
                $.ajax({
                    url: '");
            EndContext();
            BeginContext(55890, 14, false);
#line 1465 "C:\Projects\DCap\App\Brandix.DCAP.WebUI - OutSource\Views\Home\Bulk.cshtml"
                     Write(ViewBag.APIURL);

#line default
#line hidden
            EndContext();
            BeginContext(55904, 11430, true);
            WriteLiteral(@"/BusinessLogics/UpdateBulkQty',
                    type: 'POST',
                    dataType: 'json',
                    async: false,
    ...
    ");
            WriteLiteral(@"                            rmks: elements.responce[0],
                                success: elements.saveSuccessfull
                            }
    ...
    <div class=""row"">
        <div class=""col-md-4"" style=""padding-left: 0px; padding-right: 0px;"">
            ...
            <div class=""row"">
                <div class=""col-md-4"">
  ");
            WriteLiteral(@"                  <label class=""bu-control-label"">Factory :</label>
                </div>
                <div class=""col-md-6"">
        ...
        <div class=""col-md-3"" style=""padding-left: 0px; padding-right: 0px;"">
            <div class=""row"">
                <div class=""col-md-5"">
                    ");
            WriteLiteral(@"<label class=""bu-control-label"">Scan Option :</label>
                </div>
                <div class=""col-md-7"">
            ...
            <div class=""row"">
                ...
                <div class=""col-md-7"">
                    <div id=""divddlSize"">
                        <div");
            WriteLiteral(@" class=""bu-form-control"" id=""ddlSize""></div>
                    </div>
                </div>
            </div>
            <div class=""row"">
            ...
            <div class=""row"">
                ...
                <div class=""col-md-7"">
                    <div id=""divscrpQty"">
                        <input id=""scrpQty"" class=""bu-form-con");
            WriteLiteral(@"trol"" type=""number"" />
                    </div>
                </div>
                ...
                <div class=""row roundCornerGroupBox"">
                    <div class=""col-xs-6"">
                        <div class=""row"">
                            ...
                            <label class=""bu-control-datalabel col-xs-3"" id=""lb");
            WriteLiteral(@"lstyle""></label>
                        </div>
                        <div class=""row"">
    ...
    <div class=""row"">
        <div class=""col-md-12"" style=""text-align: left"">
            <button class=""k-button"" id=""b");
            WriteLiteral("tnSubmit\" onclick=\"SaveGridData()\">Submit</button>\r\n            <button id=\"btnClearAll\" class=\"k-button\">Clear All</button>\r\n        </div>\r\n    </div>\r\n\r\n\r\n</div>\r\n");
            EndContext();
        }
